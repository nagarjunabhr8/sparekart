    ...
    return (
      <div className="min-h-screen bg-slate-50 py-12">
        <div className="container-app text-center">
          <h1 className="text-3xl font-bold text-neutral-900 mb-4">Wishlist Not Found</h1>
          <p className="text-neutral-600 mb-6">This wishlist link is invalid or has expired.</p>
          <a
            href="/b2b/catalog"
    ...
    <div className="min-h-screen bg-slate-50 py-12">
      <div className="container-app">
        <div className="mb-8 flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-neutral-900">Shared Wishlist</h1>
